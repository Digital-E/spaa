...
import { applicationQuery, previewApplicationQuery, menuQuery, footerQuery } from '../../lib/queries.js'
import { getClient } from '../../lib/sanity.server.js'

import styled from 'styled-components'

import BackgroundDots from '../../components/home/background-dots.js'
  ...
  return (
    <>
      <Layout preview={preview}>
        ...
        <Container>
          <BackgroundDots />
          <Form data={data?.applicationData} forceActivate={true}/>
        </Container>
      </Layout>
    </>
  )
